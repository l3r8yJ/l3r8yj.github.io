...
Thus, on your Way of the Samurai in my experience, aim for spending roughly 70% of your time coding, not reading. Not just write stupid pieces of code in the form of to-do lists and other crap they do on courses. You **must** solve problems with coding. Only when you're looking for a way to solve a problem you do learn. Foundational reading fills gaps that problem-solving alone won't surface. But when you find it – now the books become handy, you know how to implement it in the **right way**.
You might have no idea how to find these "problems". The easiest way is to contribute to [Open Source](https://en.wikipedia.org/wiki/Open_source). Go to [GitHub](https://github.com/) and find the project that you will be involved in! Make your first contribution and feel useful, because you have contributed to something other programmers may be using! And you're just getting started.
...
one junior frontend developer, one junior tester, one junior designer, and other roles the project needs.
...
Such an experience can be equivalent to a real commercial project (if the team holds together long enough). 
...
Because often teams like the one described above fall apart after 1–4 weeks due to a lack of interest
...
I'm not talking about IDEs or development tooling right now.
I am talking about several things:
  ...
  2. [Stack Overflow](https://stackoverflow.com/) is a site where you should ask questions and possibly answer them. Learning to ask questions on this platform can help you practice expressing technical questions clearly as a software engineer.



## Sources of knowledge
I prefer books to other sources of information. You don't need to read books about the Spring framework, Hibernate, or any other technology-specific guide.
You need to read books that will deal with general aspects of software development.
Such books retain relevance far longer than books written for a specific framework.
...
### General
- [Junior Objects](https://www.yegor256.com/junior-objects.html). This book will make you a real software developer, as long as you complete all the exercises. There are many other useful books hidden inside this book.
...
- [Elegant Objects, v1-v2](https://www.yegor256.com/elegant-objects.html). Watch out! May cause a burning pain in the ass if your views on OOP are firmly set.
...
- [Crafting Interpreters](https://craftinginterpreters.com/). Well-written book about interpreter development.
